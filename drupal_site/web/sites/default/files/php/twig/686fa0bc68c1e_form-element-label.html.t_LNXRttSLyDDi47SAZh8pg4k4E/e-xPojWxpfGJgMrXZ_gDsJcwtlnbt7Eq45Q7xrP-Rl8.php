...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
    ...
    {
        return new Source("", "core/modules/system/templates/form-element-label.html.twig", "/workspaces/drupal/drupal_site/web/core/modules/system/templates/form-element-label.html.twig");
    }
